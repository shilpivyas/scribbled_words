...
function profitmag_theme_scripts() {
    ...
    wp_enqueue_script( 'bootstrap', get_template_directory_uri() . '/vendors/bootstrap/js/bootstrap.min.js', array('jquery'), '1.0', true );
    ...
    wp_enqueue_style( 'custom_style', get_template_directory_uri() . '/css/animate.css' );
    wp_enqueue_style( 'bootstrap.min', get_template_directory_uri() . '/vendors/bootstrap/css/bootstrap.min.css' );
