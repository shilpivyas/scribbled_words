...
<div id="subscription-block">
    <div class="subscription-head">
        <span class="pull-left"><i class="fa fa-newspaper-o"></i>Subscribe to Scribbled Words</span>
        <span class="pull-right chevron"><i class="fa fa-chevron-down"></i></span>
    </div>
    <div class="clearfix"></div>
    <div class="subscription-body close-block">
        <div class="clearfix"></div>
        <span class="subscription-desc">Want to be the first one to read our recent post? Subscribe Here!</span>
        <form action="#" id="subscription-form">
            <input type="text" class="form-control" placeholder="Email Address" />
            <input type="button" class="form-control btn btn-danger" value="Subscribe" />
        </form>
        <a href="javascript:" id="subscribed">Already Subscribed</a>
    </div>
    
    <img class="balloon-img" src="<?php echo get_template_directory_uri();?>/images/girl_and_ballons.png" height="150px" width="150px">
    <div class="clearfix"></div>
</div>
<?php wp_footer(); ?>
